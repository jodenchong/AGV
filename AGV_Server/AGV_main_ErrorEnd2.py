...
class MQTT_task():
    def __init__(self):
        self.CLIENT_PUBLISH = ("in/motor/AGV") 
        self.CLIENT_SUBCRIBE = ("out/motor/AGV")
        self.CLIENT_IP = ("192.168.0.104")
        self.CLIENT_PORT = (1883)
        self.CLIENT_USER = ("admin")
        self.CLIENT_PWORD = ("1234")

        self.client = mqtt.Client()
        self.client.connect(self.CLIENT_IP,self.CLIENT_PORT,60)
        self.client.on_connect = self.on_connect
        self.client.on_message = self.on_message
        self.client.username_pw_set(self.CLIENT_USER, self.CLIENT_PWORD)

    def on_connect(self, client, userdata, flags, rc):
        print('conneted MQTT')
        # stringtemp2 = eve3Init["name"] +" v2"+ " online A:" + motorList[0] + " B:" + motorList[1] + " C:" + motorList[2] + " D:" + motorList[3]
        self.client.subscribe(self.CLIENT_SUBCRIBE)
        self.client.publish (self.CLIENT_PUBLISH, "AGV Here")
...
if __name__ == '__main__':
    try:
        ...
        AGV.MQTT_TASK.client.loop_stop()
        print(".......... End ..........")
